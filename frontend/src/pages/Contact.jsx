        ...
        >
          ...
          <div className="space-y-6">
            ...
            >
              {/* Phone */}
              <motion.div
                className="flex max-md:justify-center max-md:items-center items-start space-x-4"
            ...
            >
              {/* Email */}
              <motion.div
                className="flex max-md:ml-18 max-md:justify-center max-md:items-center items-start space-x-4"
                whileHover={{ scale: 1.05 }}
                transition={{ type: "spring", stiffness: 120 }}
              >
